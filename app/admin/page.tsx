      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
          ...
          <p className="text-gray-400 text-sm mb-4">
            ...
            Select one or more segments to scrape.
          </p>
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => setSelectedSegments(SEGMENTS.map((_, i) => i))}
              disabled={scrapingCompanies}
            ...
            <button
              ...
              className="ml-auto bg-red-700 hover:bg-red-600 disabled:bg-gray-700 disabled:cursor-not-allowed text-white text-sm px-5 py-2 rounded-lg transition-colors"
            >
              {scrapingCompanies
                ? `Scraping: ${currentSegment ?? "..."}`
                : `Run Scraper (${selectedSegments.length} segment${selectedSegments.length !== 1 ? "s" : ""})`}
            </button>
          </div>
          ...
          {companyScrapeResults.length > 0 && (
            <div className="mt-4 space-y-1 text-xs">
              <p className="text-green-400 font-medium mb-2">
                Total: {totalCreated} companies added, {totalSkipped} duplicates skipped
              </p>
              {companyScrapeResults.map((r, i) => (
                <div key={i} className="text-gray-400 flex justify-between">
                  ...
                  {r.error
                    ...
                    : <span>{r.created} added · {r.skipped} skipped · {r.stockUpdated} stocks fetched</span>
                  }
                </div>
              ))}
            </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Upload Excel/CSV. Duplicates are automatically detected by name and ticker.
            </p>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            ...
            <p className="text-gray-400 text-sm mb-4">Fetch latest semiconductor news from RSS feeds. Claude summarizes each article.</p>
            <button
              onClick={runScraper}
              disabled={scraping}
                ...
                {scrapeResult.error ? (
                  ...
                  <div className="text-gray-300 space-y-1">
                    <p className="text-green-400 font-medium">
                      ✓ {scrapeResult.added} added, {scrapeResult.skipped} skipped{scrapeResult.summarized ? `, ${scrapeResult.summarized} AI-summarized` : ""}
                    </p>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            ...
            <p className="text-gray-400 text-sm mb-4">Claude assigns categories to uncategorized companies (30 at a time).</p>
            <button
